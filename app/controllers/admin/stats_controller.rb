  ...
  class StatsController < Admin::AdminController
    def index
      @years = if params[:nopandemic] == "true"
                 %w[2006 2007 2008 2009 2010 2011 2012 2013 2014 2015 2016 2017 2018 2019 2021 2022 2023 2024]
               else
                 %w[2006 2007 2008 2009 2010 2011 2012 2013 2014 2015 2016 2017 2018 2019 2020 2021 2022 2023 2024]
               end
      @racer_days_gender_ratio = Stats.racer_days_gender_ratio(@years)
      ...
      @gender_ratio = Stats.gender_ratio(@years)
