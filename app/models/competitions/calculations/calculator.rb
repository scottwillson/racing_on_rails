...
module Competitions::Calculations::Calculator
  extend Competitions::Calculations::Place
  extend Competitions::Calculations::Points
  extend Competitions::Calculations::Rules
  extend Competitions::Calculations::SelectResults
  extend Competitions::Calculations::SelectScores
  extend Competitions::Calculations::Structs
  extend Competitions::Calculations::Teams
