class UseExplicitIndexAndFkNames < ActiveRecord::Migration
  def self.up
    # Sadly, schemas are not totally congruent, so be fault-tolerant rescue nil
    ...
    execute "alter table competition_event_memberships drop foreign key competition_event_memberships_ibfk_1" rescue nil
    execute "alter table competition_event_memberships drop foreign key competition_event_memberships_ibfk_2" rescue nil
