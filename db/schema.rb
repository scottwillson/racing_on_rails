...
ActiveRecord::Schema.define(version: 20180306163607) do
  ...
  add_index "#tableau_01_sid_00026e8b_4_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_00026E8B_4_Group_1a", using: :btree

  create_table "#Tableau_01_sid_0004055D_4_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 11
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_0004055d_4_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_0004055D_4_Group_1a", length: {"Age (group)"=>5}, using: :btree

  create_table "#Tableau_01_sid_000405D7_10_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_10_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_10_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_11_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_11_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_11_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_12_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_12_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_12_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_13_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_13_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_13_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_14_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_14_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_14_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_1_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 11
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_1_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_1_Group_1a", length: {"Age (group)"=>5}, using: :btree

  create_table "#Tableau_01_sid_000405D7_2_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_2_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_2_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_3_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_3_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_3_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_4_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_4_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_4_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_5_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_5_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_5_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_6_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_6_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_6_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_7_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_7_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_7_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_8_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_8_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_8_Group_1a", using: :btree

  create_table "#Tableau_01_sid_000405D7_9_Group", id: false, force: :cascade do |t|
    t.string  "Age (group)", limit: 21
    t.integer "age",         limit: 4
  end

  add_index "#tableau_01_sid_000405d7_9_group", ["Age (group)"], name: "_tidx_#Tableau_01_sid_000405D7_9_Group_1a", using: :btree
