...
ActiveRecord::Schema.define(:version => 20130802185855) do
  ...
  create_table "discount_codes", :force => true do |t|
    ...
    t.string   "use_for",                                        :default => "event", :null => false
  end

  add_index "discount_codes", ["event_id"], :name => "event_id"
  add_index "discount_codes", ["use_for"], :name => "index_discount_codes_on_use_for"
  ...
  add_index "line_items", ["additional_product_variant_id"], :name => "index_line_items_on_additional_product_variant_id"
  add_index "line_items", ["discount_code_id"], :name => "index_line_items_on_discount_code_id"
  ...
  add_index "line_items", ["purchased_discount_code_id"], :name => "index_line_items_on_purchased_discount_code_id"
  add_index "line_items", ["race_id"], :name => "index_line_items_on_race_id"
  ...
  add_index "order_people", ["order_id"], :name => "index_order_people_on_order_id"
  add_index "order_people", ["person_id"], :name => "index_order_people_on_person_id"
  ...
  add_index "orders", ["purchase_time"], :name => "index_orders_on_purchase_time"
  ...
  add_index "payment_gateway_transactions", ["created_at"], :name => "index_order_transactions_on_created_at"
  add_index "payment_gateway_transactions", ["line_item_id"], :name => "index_payment_gateway_transactions_on_line_item_id"
  add_index "payment_gateway_transactions", ["order_id"], :name => "index_order_transactions_on_order_id"
  ...
  add_index "people", ["non_member_result_id"], :name => "index_people_on_non_member_result_id"
  ...
  add_index "people_roles", ["role_id"], :name => "role_id"
  ...
  add_index "refunds", ["line_item_id"], :name => "index_refunds_on_line_item_id"
  ...
  add_index "regions", ["friendly_param"], :name => "index_regions_on_friendly_param", :unique => true
  ...
  add_index "results", ["non_member_result_id"], :name => "index_results_on_non_member_result_id"
  ...
  add_index "update_requests", ["expires_at"], :name => "index_update_requests_on_expires_at"
  add_index "update_requests", ["order_person_id"], :name => "index_update_requests_on_order_person_id", :unique => true
  add_index "update_requests", ["token"], :name => "index_update_requests_on_token"
