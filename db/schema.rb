...
ActiveRecord::Schema.define(version: 2021_03_11_164253) do
  ...
  create_table "calculations_categories_mappings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
