...
class CategoriesTest < WebDriverTestCase
  def test_edit
    ...
    assert_no_element :xpath => "//div[@id='association_category_root']//div[@id='category_#{masters_35_plus_id}']"
    ...
    wait_for_element :xpath => "//div[@id='association_category_root']//div[@id='category_#{masters_35_plus_id}']"
  end
end
