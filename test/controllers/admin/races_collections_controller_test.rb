...
module Admin
  ...
  class RacesCollectionsControllerTest < ActionController::TestCase
    ...
    test "edit" do
      ...
      get :edit, params: { xhr: true, params: { event_id: race.event } }
    ...
    test "show" do
      ...
      race = FactoryBot.create(:race)
      FactoryBot.create(:race, event: race.event)
      get :show, params: { xhr: true, params: { event_id: race.event } }
      assert_response :success
      assert_not_nil assigns[:races_collection], "@races_collection"
    end
    ...
    test "update" do
      ...
      race = FactoryBot.create(:race)
      FactoryBot.create(:race, event: race.event)
      put :update, params: { xhr: true, params: { event_id: race.event, races_collection: { text: "Senior Men\r\nCat 3" } } }
      assert_response :success
      assert_not_nil assigns[:races_collection], "@races_collection"
    ...
    test "create" do
      ...
      post :create, params: { xhr: true, params: { event_id: event } }
      assert_response :success
