...
class PasswordResetsControllerTest < ActionController::TestCase
  ...
  test "forgot password" do
    ...
    post :create, params: { params: { email: "admin@example.com" } }
  ...
  test "forgot password error" do
    ActionMailer::Base.deliveries.clear
    post :create, params: { params: { email: "noperson@example.com" } }
  ...
  test "forgot password invalid email" do
    ActionMailer::Base.deliveries.clear
    post :create, params: { params: { email: "bob.jones" } }
    assert_response :success
    assert_equal 0, ActionMailer::Base.deliveries.count, "Should send one email"
  end
  ...
  test "forgot password blank email" do
    ActionMailer::Base.deliveries.clear
    Person.create! email: ""
    post :create, params: { params: { email: "" } }
    assert_response :success
    assert_equal 0, ActionMailer::Base.deliveries.count, "Should send one email"
  end
  ...
  test "edit" do
    ...
    get :edit, params: { params: { id: member.perishable_token } }
    assert_response :success
  ...
  test "update admin" do
    ...
    post :update, params: { params: { id: administrator.perishable_token, person: { password: "my new password", password_confirmation: "my new password" } } }
  ...
  test "update member" do
    ...
    post :update, params: { params: { id: person.perishable_token, person: { password: "my new password", password_confirmation: "my new password" } } }
    assert_not_nil(assigns["person"], "@person")
    assert_not_nil(assigns["person_session"], "@person_session")
  ...
  test "invalid update" do
    ...
    post :update, params: { params: { id: member.perishable_token, person: { password: "my new password", password_confirmation: "another password that doesn't match" } } }
  ...
  test "blank update" do
    member = FactoryBot.create(:person_with_login)
    password = member.crypted_password
    post :update, params: { params: { id: member.perishable_token, person: { password: "", password_confirmation: "" } } }
    assert_nil(assigns["person_session"], "@person_session")
    assert_not_nil(assigns["person"], "@person")
    assert_not_nil(assigns("person").errors[:password], "Should have error on password")
