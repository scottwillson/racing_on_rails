  ...
  module People
    class ExportTest < ActionController::TestCase
      ...
      def test_export_to_excel
        today = Date.new(Time.zone.now.year, 11)
        Timecop.freeze(today) do
          ...
          expected_body = [
            ...
            "576	Kevin	Con'Condron	Gentle Lovers	12/31/1999	12/31/2011	0	0		0							0	kc@example.com	0																	0	0	0	0	#{Time.zone.now.to_s(:mdY)}	#{Time.zone.now.to_s(:mdY)}\n",
