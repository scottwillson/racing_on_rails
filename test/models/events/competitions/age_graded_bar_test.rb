...
module Competitions
  ...
  class AgeGradedBarTest < ActiveSupport::TestCase
    test "calculate" do
      ...
      weaver = FactoryBot.create(:person, date_of_birth: Date.new(1972))
      banana_belt_1 = FactoryBot.create(:event, date: Date.new(2004), name: "Banana Belt")
      ...
      tonkin = FactoryBot.create(:person, date_of_birth: Date.new(1968), name: "Tonkin")
      masters_35_39 = FactoryBot.create(:category, name: "Masters Men 35-39", ages: 35..39, parent: masters_men)
      ...
      molly = FactoryBot.create(:person, date_of_birth: Date.new(1965), name: "Molly")
      banana_belt_masters.results.create!(person: molly, place: '15')

      # Racing age is 35, but was 34 on race day
      carl_roberts = FactoryBot.create(:person, date_of_birth: Date.new(1969, 11, 2),
      ...
      david_auker = FactoryBot.create(:person, member_from: Date.new(2004), member_to: Date.new(2004, 12, 31), name: "Auker")
      banana_belt_masters.results.create!(person: david_auker, place: '9')

      # Result by a 32-year-old and a 36 year-old in a 30-39 race
      banana_belt_2 = FactoryBot.create(:event, date: Date.new(2004), name: "Banana Belt 2")
      masters_30_39 = FactoryBot.create(:category, name: "Masters Men 30-39", ages: 30..39, parent: masters_men)
