...
require File.expand_path("../../../../../lib/grid/base", __FILE__)
require File.expand_path("../../../../../lib/grid/row", __FILE__)
require File.expand_path("../../../../../lib/grid/column", __FILE__)

module Grid
  # :stopdoc:
  class BaseTest < Ruby::TestCase
    def test_new
      Grid::Base.new
    end
    ...
    def test_new_empty_text
      ...
      grid = Grid::Base.new(text, header_row: true)
      assert_equal(0, grid.column_count, "column count")
      assert_equal(0, grid.row_count, "row count")
      assert_equal(0, grid.column_size(0), "column 0 size")
      assert_equal(0, grid.column_size(90), "column 90 size")
...
END
  ...
  text = <<END
    ...
    dnf\t100\tBourcier\tPaul\tHutch's\tSenior Men 1/2/3\t\t\t1
END
      grid = Grid::Base.new(text, columns: columns)
