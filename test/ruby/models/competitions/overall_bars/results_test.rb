...
require File.expand_path("../../../../../../app/models/competitions/overall_bars/results", __FILE__)

# :stopdoc:
class Competitions::OverallBars::ResultsTest < Ruby::TestCase
  class TestBar
    include Competitions::OverallBars::Results
  end
