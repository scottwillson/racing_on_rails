...
class Test::Unit::TestCase
  ...
  fixtures :teams, :racers, :duplicates, :duplicates_racers, :disciplines, :aliases, :aliases_disciplines, :categories, :number_issuers, :race_numbers, :promoters, :events, :standings, :races, :results, :scores, :discipline_bar_categories, :users, :mailing_lists, :posts, :velodromes
