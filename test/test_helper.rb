...
class Test::Unit::TestCase
  ...
  fixtures :teams, :racers, :disciplines, :aliases, :aliases_disciplines, :categories, :number_issuers, :race_numbers, :promoters, :events, :standings, :races, :results, :discipline_bar_categories, :users, :mailing_lists, :posts
