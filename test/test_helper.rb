...
class Test::Unit::TestCase
  ...
  # use_transactional_fixtures actually commits fixtures to the database
  # once per run, leaving the fixtures in database. Fixtures are NOT 
  # wrapped in transaction and rolled-back
