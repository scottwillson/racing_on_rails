...
class MtbBarTest < ActiveSupport::TestCase
  ...
  def test_numerical_mtb_categories
    ...
    assert_equal(weaver, senior_men_road_bar.results[0].person, "Senior Men Road BAR results person")
    assert_equal(tonkin, senior_men_road_bar.results[1].person, "Senior Men Road BAR results person")
    assert_equal(molly, senior_men_road_bar.results[2].person, "Senior Men Road BAR results person")
    ...
    assert([matson, weaver].include?(senior_men_overall_bar.results[0].person), "Senior Men Overall BAR results person")
    ...
    assert([matson, weaver].include?(senior_men_overall_bar.results[1].person), "Senior Men Overall BAR results person")
    ...
    assert_equal(tonkin, senior_men_overall_bar.results[2].person, "Senior Men Overall BAR results person")
    ...
    assert_equal(molly, senior_men_overall_bar.results[3].person, "Senior Men Overall BAR results person")
    ...
    assert([alice, molly].include?(senior_men_3_overall_bar.results[0].person), "Senior Men Overall BAR results person")
    ...
    assert([alice, molly].include?(senior_men_3_overall_bar.results[1].person), "Senior Men Overall BAR results person")
    ...
    senior_men_4_5_overall_bar.results.sort
    assert_equal weaver, senior_men_4_5_overall_bar.results[0].person, "Senior Men Overall BAR results person"
    ...
    assert([matson, weaver, tonkin].include?(senior_men_4_5_overall_bar.results[1].person), "Senior Men Overall BAR results person")
    ...
    assert([matson, weaver, tonkin].include?(senior_men_4_5_overall_bar.results[2].person), "Senior Men Overall BAR results person")
