  ...
  module Competitions
    class WsbaBarrTest < ActiveSupport::TestCase
      def test_points
        ...
        assert_equal(21, men_1_2.results[0].points, "Result 0 points")
        assert_equal(17, men_1_2.results[1].points, "Result 1 points")
        assert_equal(15, men_1_2.results[2].points, "Result 2 points")
      end
    end
  end
end
