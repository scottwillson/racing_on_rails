  ...
  module Competitions
    class WsbaMastersBarrTest < ActiveSupport::TestCase
      def test_points
        ...
        race.results.sort!
        assert_equal(27, race.results[0].points, "Result 0 points")
        assert_equal(17, race.results[1].points, "Result 1 points")
        assert_equal(15, race.results[2].points, "Result 2 points")
      end
    end
  end
end
