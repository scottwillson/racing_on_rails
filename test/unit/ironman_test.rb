...
class IronmanTest < Test::Unit::TestCase
  
  def test_recalculate
    results_baseline_count = Result.count
    assert_equal(0, Ironman.count, "Ironman standings before recalculate")
    assert_equal(11, Result.count, "Total count of results in DB before Ironman recalculate")
    ...
    assert_equal(16, Result.count, "Total count of results in DB")
