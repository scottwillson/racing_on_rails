...
Downhill/Cross Country: Downhill}
  ...
  def test_excel_file_database
    ...
    assert(quinn_jackson.notes['interests: 14'], 'Quinn Jackson notes')
    ...
    assert(brian_abers.notes['Existing notes'], "Brian Abers notes in #{brian_abers.notes}")
    assert(brian_abers.notes['interests: 1247'], "Brian Abers notes in #{brian_abers.notes}")
    ...
    assert(heidi_babi.notes["interests: 134"], 'Heidi Babi notes')
    ...
    assert(scott_seaton.notes['interests: 3146'], 'Scott Seaton notes')
