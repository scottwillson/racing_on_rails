...
class Calculations::V3::AssignPointsTest < Ruby::TestCase
  def test_assign_points
    ...
    source_result = Calculations::V3::Models::SourceResult.new(id: 33, place: 1)
    ...
    source_result = Calculations::V3::Models::SourceResult.new(id: 19, place: 2)
    ...
    assert_equal 75, event_categories.first.results.second.source_results.first.points
  end
end
