...
class Admin::EventsControllerTest < Test::Unit::TestCase
  ...
  def test_upload
    ...
    file = uploaded_file("/test/files/pir_2006_format.xls", "pir_2006_format.xls", "application/vnd.ms-excel")
    opts = {
  ...
  def test_upload_invalid_columns
    ...
    file = uploaded_file("/test/files/invalid_columns.xls", "invalid_columns.xls", "application/vnd.ms-excel")
    post :upload, :id => mt_hood_1.to_param, :results_file => file
    assert_redirected_to(:action => :show, :id => mt_hood_1.to_param, :standings_id => mt_hood_1.standings(true).last.to_param)
  ...
  def test_upload_dupe_racers
    ...
    file = uploaded_file("/test/files/dupe_racers.xls", "dupe_racers.xls", "application/vnd.ms-excel")
    post :upload, :id => mt_hood_1.to_param, :results_file => file
